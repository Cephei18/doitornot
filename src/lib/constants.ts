 ...
 */
export const APP_NAME: string = 'DoItOrNot';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'A personality-driven app that makes your decisions for you, no overthinking, just do it or not.';
 ...
 */
export const APP_TAGS: string[] = ['fun', 'game', 'decision'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'Let\'s Decide';
